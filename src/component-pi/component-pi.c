...
void montecarlo(double, double, double, double, int, int, int);
...
int main(int argc, char* argv[])
{
    ...
    for(i = 0; i <= N; i++) {
        montecarlo(x, y, z, pi, count, iCPU, niter);
    }

    return 0;
}

void montecarlo(double x, double y, double z, double pi, int count, int iCPU, int niter) {
    int i; 
